                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('categories.update', $category->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ $category->name }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{url()->previous()}}" class="bg-red-400 text-white px-4 py-2 rounded">Cancel</a>
